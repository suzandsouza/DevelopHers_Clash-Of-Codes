  ...
  return (
    <div className='text-center bg-white text-gray-800 py-24 px-6'>
     ...
     <div className='flex justify-center items-center space-x-2'>
        <button type='button' className='inline-block px-6 py-2.5 bg-green-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-green-700'>Add Art</button>
        ...
        hover:text-white'>Back projects</button>
     </div>
